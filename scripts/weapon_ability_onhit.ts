...
//     if (onHitCooldown === 0) {
//       switch (true) {
//         case currentLore && currentLore.some((line: string) => line === "§r§d[On-Hit] Steal A PORTION of Enemy Health"):
//           let hurthealth = hurtEntity.getComponent(`health`) as Minecraft.EntityHealthComponent;
//           if (hurthealth) {
...
//           break;
//         case currentLore && currentLore.some((line: string) => line === "§r§d[On-Hit] Infect Hurt With Weakness"):
//           hurtEntity.addEffect(`weakness`, 60, { amplifier: 2 });
//           player.setDynamicProperty(`on_hit_cooldown`, onHitCooldown + 1);
//           break;
//         case currentLore && currentLore.some((line: string) => line === "§r§d[On-Hit] Poison The Enemy"):
...
//           player.setDynamicProperty(`on_hit_cooldown`, onHitCooldown + 1);
//           break;
//         case currentLore && currentLore.some((line: string) => line === "§r§d[On-Hurt] 80% Chace to burn the attacker"):
