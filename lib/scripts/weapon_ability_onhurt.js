...
export function weapon_onhurt() {
    ...
    Minecraft.world.afterEvents.entityHurt.subscribe((event) => {
        ...
        if (!currentLore)
            return;
        switch (true) {
            case currentLore.some((line) => line === "§r§d[On-Hurt] Rewind A Portion Of Taken Damage") &&
                onHurtCooldown === 0:
                {
    ...
    Minecraft.world.afterEvents.entityHitEntity.subscribe((event) => {
        ...
        if (!currentLore)
            return;
        switch (true) {
            case currentLore.some((line) => line === "§r§d[On-Hurt] Drop SOULS from getting hurt") &&
                onHurtCooldown === 0:
                ...
                break;
            case currentLore.some((line) => line === "§r§d[On-Hurt] AoE Poison Where you are hurt") &&
                onHurtCooldown === 0:
            ...
            case currentLore.some((line) => line === "§r§d[On-Hurt] Summon AoE WITHER") && onHurtCooldown === 0:
                ...
                player.setDynamicProperty("on_hurt_cooldown", 1);
                break;
            case currentLore.some((line) => line === "§r§d[On-Hurt] 40% Chace to burn the attacker") &&
                onHurtCooldown === 0:
                ...
                break;
            case currentLore.some((line) => line === "§r§d[On-Hurt] Curse The Attacker") && onHurtCooldown === 0:
